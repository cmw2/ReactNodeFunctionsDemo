...
set sqlpackage_path="c:\Program Files\Microsoft Visual Studio\2022\Enterprise\Common7\IDE\Extensions\Microsoft\SQLDB\DAC\SqlPackage.exe"
set bacpac_path="C:\repos\ReactNodeFunctionsDemo\db\WideWorldImporters-Standard.bacpac"
...
echo Running...
%sqlpackage_path% /a:import /tcs:"Data Source=%azure_sql_server%.database.windows.net;Initial Catalog=%azure_sql_database%;User Id=%azure_sql_login%;Password=%azure_sql_password%" /sf:%bacpac_path% 
goto END
